...
export const ascensionGemMap = new Map<AscensionGem, IAscensionGem>([
  ...
  [
    'Shivada Jade Chunk',
    { name: 'Shivada Jade Chunk', rarity: 4, group: 'Shivada Jade', count: 0 },
  ],
  [
  ...
  [
    'Shivada Jade Sliver',
    { name: 'Shivada Jade Sliver', rarity: 2, group: 'Shivada Jade', count: 0 },
  ],
...
export const commonMaterialMap = new Map<CommonMaterial, ICommonMaterial>([
  [
    'Slime Concentrate',
    { name: 'Slime Concentrate', rarity: 3, group: 'Slime', count: 0 },
  ],
  [
    'Slime Secretions',
    { name: 'Slime Secretions', rarity: 2, group: 'Slime', count: 0 },
  ],
  [
    'Slime Condensate',
    { name: 'Slime Condensate', rarity: 1, group: 'Slime', count: 0 },
  ],

  [
    'Ominous Mask',
    { name: 'Ominous Mask', rarity: 3, group: 'Hilichurl Masks', count: 0 },
  ],
  [
    'Stained Mask',
    { name: 'Stained Mask', rarity: 2, group: 'Hilichurl Masks', count: 0 },
  ],
  [
    'Damaged Mask',
    { name: 'Damaged Mask', rarity: 1, group: 'Hilichurl Masks', count: 0 },
  ],
  ...
  [
    'Sealed Scroll',
    { name: 'Sealed Scroll', rarity: 2, group: 'Samachurl Scrolls', count: 0 },
  ],
  [
    'Divining Scroll',
    {
  ...
  [
    'Heavy Horn',
    { name: 'Heavy Horn', rarity: 2, group: 'Hilichurl Horns', count: 0 },
  ],

  [
    'Ley Line Sprout',
    { name: 'Ley Line Sprout', rarity: 4, group: 'Ley Lines', count: 0 },
  ],
  [
    'Dead Ley Line Leaves',
    { name: 'Dead Ley Line Leaves', rarity: 3, group: 'Ley Lines', count: 0 },
  ],
  [
    'Dead Ley Line Branch',
    { name: 'Dead Ley Line Branch', rarity: 2, group: 'Ley Lines', count: 0 },
  ],

  [
    'Chaos Core',
    { name: 'Chaos Core', rarity: 4, group: 'Chaos Parts', count: 0 },
  ],
  [
    'Chaos Circuit',
    { name: 'Chaos Circuit', rarity: 3, group: 'Chaos Parts', count: 0 },
  ],
  [
    'Chaos Device',
    { name: 'Chaos Device', rarity: 2, group: 'Chaos Parts', count: 0 },
  ],

  [
    'Mist Grass Wick',
    { name: 'Mist Grass Wick', rarity: 4, group: 'Mist Grass', count: 0 },
  ],
  [
    'Mist Grass',
    { name: 'Mist Grass', rarity: 3, group: 'Mist Grass', count: 0 },
  ],
  [
    'Mist Grass Pollen',
    { name: 'Mist Grass Pollen', rarity: 2, group: 'Mist Grass', count: 0 },
  ],
  ...
  [
    'Sturdy Bone Shard',
    { name: 'Sturdy Bone Shard', rarity: 3, group: 'Bone Shards', count: 0 },
  ],
  [
    'Fragile Bone Shard',
    { name: 'Fragile Bone Shard', rarity: 2, group: 'Bone Shards', count: 0 },
  ],
  ...
  [
    'Old Handguard',
    { name: 'Old Handguard', rarity: 1, group: 'Nobushi Handguards', count: 0 },
  ],
  ...
  [
    'Chaos Axis',
    { name: 'Chaos Axis', rarity: 3, group: 'Sentinel Chaos Parts', count: 0 },
  ],
  [
    'Chaos Gear',
    { name: 'Chaos Gear', rarity: 2, group: 'Sentinel Chaos Parts', count: 0 },
  ],

  [
    'Polarizing Prism',
    { name: 'Polarizing Prism', rarity: 4, group: 'Prisms', count: 0 },
  ],
  [
    'Crystal Prism',
    { name: 'Crystal Prism', rarity: 3, group: 'Prisms', count: 0 },
  ],
  [
    'Dismal Prism',
    { name: 'Dismal Prism', rarity: 2, group: 'Prisms', count: 0 },
  ],

  [
    'Spectral Nucleus',
    { name: 'Spectral Nucleus', rarity: 3, group: 'Spectral Cores', count: 0 },
  ],
  [
    'Spectral Heart',
    { name: 'Spectral Heart', rarity: 2, group: 'Spectral Cores', count: 0 },
  ],
  [
    'Spectral Husk',
    { name: 'Spectral Husk', rarity: 1, group: 'Spectral Cores', count: 0 },
  ],
